...
from src.cache.redis_client import init_redis_client, get_redis_client
from src.database.connection import init_db_connection, get_db_connection
from src.services.distributed_lock import init_distributed_lock, get_distributed_lock
from src.services.schedule_repository import init_schedule_repository, get_schedule_repository
from src.services.schedule_watcher import init_schedule_watcher, get_schedule_watcher
from src.services.job_history import init_job_history, get_job_history
from src.services.scheduled_scan_executor import (
...
class EnhancedScheduler:
    ...
    def sync_schedules_from_database(self) -> Dict[str, int]:
        ...
        """
        logger.info("Syncing schedules from src.database...")
